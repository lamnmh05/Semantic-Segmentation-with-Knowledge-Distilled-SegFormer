...
![Per-class IoU Top 30](../eval_results/others/per_class_iou_top30.png)
*(Hình 2: So sánh IoU của các phương pháp trên 30 lớp xuất hiện nhiều nhất)*

![IoU Improvement Histogram](../eval_results/others/iou_improvement_histogram.png)
*(Hình 3: Phân bố sự cải thiện IoU của Combine so với baseline tốt nhất trên 150 lớp)*
...
![Error Taxonomy Breakdown](../eval_results/others/error_taxonomy.png)
*(Hình 4: Tỷ lệ phân bổ Boundary Error và Misclass Error trên các mô hình)*

![Absolute Error Count](../eval_results/others/error_absolute_count.png)
*(Hình 5: Số lượng pixel lỗi tuyệt đối của từng loại lỗi theo mô hình)*
...
*(Hình 6: Lưới so sánh 10 ảnh (Row 1-10 tương ứng từ trên xuống). Cột (a) Ảnh gốc, (b) Ground Truth, (c) MLP, (d) BPKD, (e) Combine, (f) Teacher)*
